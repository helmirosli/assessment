...
class RunCloudAssessmentCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'runcloud:assessment';
     ...
     * @var string
     */
    protected $description = 'RunCloud Server Management Panel Simplified Version.';
